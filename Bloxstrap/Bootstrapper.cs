...
namespace Bloxstrap
{
    public class Bootstrapper
    {
        ...
        public string BackgroundUpdaterMutexName => $"Johnstrap-BackgroundUpdater-{_launchMode}";

        public string MutexNamePrefix { get; set; } = "Johnstrap-Bootstrapper";
        ...
        private async Task<bool> CheckForUpdates()
        {
            ...
            {
                App.Logger.WriteLine(LOG_IDENT, $"More than one Johnstrap instance running, aborting update check");
                return false;
            }
